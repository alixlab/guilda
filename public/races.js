...
<div class="bgcolor-item d-flex justify-content-end">
    ...
    <picture class="picture-monster d-flex align-item-center">
        <img class="monster img-fluid" srcset="/public/img/characters/${race.slug}.png">
    </picture>
</div>
`);
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            <img src="/public/img/characters/${race.slug}.png" class="picture-monster image-responsive">
          </div>
        </div>
      </div>
    </div>
