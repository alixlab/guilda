...
function detailMonster(monster) {
  ...
  monster.abilities.forEach(ability => {
    $('#abilities').append(`<span class="description">${monster.special_abilities}</span>`);
  });

  monster.actions.forEach(action => {
    $('#actions').append(`<span class="description">${monster.actions}</span>`);
  });

  monster.legendary.forEach(legendary => {
    $('#legendary').append(`<span class="description">${monster.legendary_actions}</span>`);
  });
}
